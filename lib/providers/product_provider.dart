...
class Products with ChangeNotifier {
  ...
  void fetchProducts() async {
    ...
    await FirebaseFirestore.instance
      ...
      productsSnapshot.docs.forEach((product) {
        tempProducts.insert(
          ...
          Product(
            ...
            price: double.parse(product.get('productPrice')),
      ...
      _products.replaceRange(0, tempProducts.length + 1, tempProducts);
      // _products.insertAll(0, tempProducts);
    });
  }
  ...
  List<Product> findByCategory(String categoryName) {
    List<Product> _productCategories = _products.where((product) {
      return product.productCategoryName == categoryName;
    }).toList();
    return _productCategories;
  }

  List<Product> findByBrand(String brandName) {
    List<Product> _productBrand = _products.where((product) {
